    ...
    <section id="skills" ref={ref}>
      <div style={{ backgroundColor: "#222831", height: "100vh" }}>
        <div className="container-projects">
          ...
          >
            <div className="title-text">Tech Stack & Tools</div>
          ...
          <div
            ...
            // class="grid grid-cols-7 gap-4 justify-center items-center text-center"
            // style={{ display: "flex", gap: "25px", width: "200px" }}

            // class="grid grid-cols-5 md:grid-cols-10 gap-4 justify-center items-center text-center"
          >
            ...
            <div class="relative inline-block">
              <div>
                ...
                >
                  ...
                  <span class="sr-only">Firebase</span>
                </div>
              </div>
            </div>
            ...
            <div class="relative inline-block">
              <div>
                ...
                >
                  ...
                  <span class="sr-only">SQL Server</span>
                </div>
              </div>
            </div>
